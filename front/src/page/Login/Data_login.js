...
{
  return [
    { ユーザーネーム: "AA", パスワード: "", ID: "", 応募相手: "いない", 募集相手: "", 米ポイント: 100 },
    { ユーザーネーム: "BB", パスワード: "B",ID: "B", 応募相手: "いない", 募集相手: "", 米ポイント: 50 },
    { ユーザーネーム: "CC", パスワード: "C", ID: "C", 応募相手: "いない", 募集相手: "", 米ポイント: 80 },
    { ユーザーネーム: "DD", パスワード: "D", ID: "D", 応募相手: "いない", 募集相手: "", 米ポイント: 200 }
  ];
};
export const my_Registration_Data= (My_address) => //ID情報を基に登録情報保存されたデータベース内の一部テーブルを取得する関数
{
    return { ユーザーネーム: "AA", パスワード: "", ID: "", 応募相手: "いない", 募集相手: "" };
}
//ーーーーー
